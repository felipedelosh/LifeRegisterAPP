...
public class TimeDistributionAdapter extends BaseAdapter {
    ...
    private List<ItemTimeInversion> arrayListItemTimeInversion;
    ...
    public TimeDistributionAdapter(List<ItemTimeInversion> arrayListItemTimeInversion, Context context, ArrayList<String> spinnerValues) {
